...
public class RandomData implements Iterable<Object> {
    ...
    public static final String STRING_PADRAO = "texto-qualquer";
    public static final int INT_PADRAO = 123;
    public static final long LONG_PADRAO = 123;
        ...
        switch (schema.getType()) {
            case RECORD:
                ...
                for (Schema.Field field : schema.getFields()) {
                    ...
                    if (field.name().toLowerCase().contains("data")) {
                        record.put(field.name(), "2020-01-01");
                        return record;
                    }
